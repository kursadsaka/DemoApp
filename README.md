...
This a homework project to become familiar with the code repository with continuous integration and deployment.<br />
...
The first operation will be true if cube of the integer found in the first list.<br />
...
Demo site: https://quiet-headland-61434.herokuapp.com/
